...
var _exercism$xelm$Bob$stringOfNothing = function (string) {
	return A2(
		_elm_lang$core$Regex$contains,
		_elm_lang$core$Regex$regex('^[\\s\\r\\t\\n]+$'),
		string);
};
var _exercism$xelm$Bob$allUppercase = function (charList) {
	return A2(_elm_lang$core$List$all, _elm_lang$core$Char$isUpper, charList);
};
var _exercism$xelm$Bob$listOfChars = function (string) {
...
var _exercism$xelm$Bob$hey = function (string) {
	return (_elm_lang$core$String$isEmpty(string) || _exercism$xelm$Bob$stringOfNothing(string)) ? 'Fine. Be that way!' : (((A2(_elm_lang$core$String$endsWith, '?', string) && _elm_lang$core$Basics$not(
		_exercism$xelm$Bob$allUppercase(
			_exercism$xelm$Bob$listOfChars(string)))) || A2(
		_elm_lang$core$Regex$contains,
		_elm_lang$core$Regex$regex('\\d\\?'),
		string)) ? 'Sure.' : ((_exercism$xelm$Bob$allUppercase(
		_exercism$xelm$Bob$listOfChars(string)) && _elm_lang$core$Basics$not(
		_elm_lang$core$List$isEmpty(
			_exercism$xelm$Bob$listOfChars(string)))) ? 'Whoa, chill out!' : 'Whatever.'));
};
