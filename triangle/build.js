...
var _exercism$xelm$Triangle$scalene = F3(
	function (num1, num2, num3) {
		var case3 = !_elm_lang$core$Native_Utils.eq(num2, num3);
		var case2 = !_elm_lang$core$Native_Utils.eq(num1, num3);
		var case1 = !_elm_lang$core$Native_Utils.eq(num1, num2);
		return (case1 && (case2 && case3)) ? true : false;
	});
var _exercism$xelm$Triangle$isosceles = F3(
	function (num1, num2, num3) {
		var case3 = _elm_lang$core$Native_Utils.eq(num2, num3);
		var case2 = _elm_lang$core$Native_Utils.eq(num1, num3);
		var case1 = _elm_lang$core$Native_Utils.eq(num1, num2);
...
var _exercism$xelm$Triangle$equilateral = F3(
	function (num1, num2, num3) {
		return A2(
			_elm_lang$core$List$all,
			function (x) {
				return _elm_lang$core$Native_Utils.eq(x, num1);
			},
			_elm_lang$core$Native_List.fromArray(
				[num1, num2, num3])) ? true : false;
	});
var _exercism$xelm$Triangle$unequal = F3(
	function (num1, num2, num3) {
		var case3 = _elm_lang$core$Native_Utils.cmp(num2 + num3, num1) > -1;
		var case2 = _elm_lang$core$Native_Utils.cmp(num1 + num3, num2) > -1;
		var case1 = _elm_lang$core$Native_Utils.cmp(num1 + num2, num3) > -1;
		return (case1 && (case2 && case3)) ? false : true;
	});
var _exercism$xelm$Triangle$hasZeroes = function (x) {
	return _elm_lang$core$Native_Utils.cmp(x, 0) < 1;
};
var _exercism$xelm$Triangle$triangleKind = F3(
	function (num1, num2, num3) {
		var sca = A3(_exercism$xelm$Triangle$scalene, num1, num2, num3);
		var iso = A3(_exercism$xelm$Triangle$isosceles, num1, num2, num3);
		var eq = A3(_exercism$xelm$Triangle$equilateral, num1, num2, num3);
		var violates = A3(_exercism$xelm$Triangle$unequal, num1, num2, num3);
		var list = _elm_lang$core$Native_List.fromArray(
			[num1, num2, num3]);
		var invalid = A2(_elm_lang$core$List$any, _exercism$xelm$Triangle$hasZeroes, list);
		return invalid ? _elm_lang$core$Result$Err('Invalid lengths') : (violates ? _elm_lang$core$Result$Err('Violates inequality') : (eq ? _elm_lang$core$Result$Ok('equilateral') : (iso ? _elm_lang$core$Result$Ok('isosceles') : (sca ? _elm_lang$core$Result$Ok('scalene') : _elm_lang$core$Result$Ok('Some kind of Triangle')))));
	});
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_elm_lang$core$Result$Err('Violates inequality'),
				A3(_exercism$xelm$Triangle$triangleKind, 2, 4, 1))),
			A2(
			_elm_community$elm_test$ElmTest$test,
