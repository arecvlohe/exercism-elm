...
var _exercism$xelm$Raindrops$isDivisibleBy7 = function (num) {
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], num, 7),
		0) ? 'Plong' : '';
};
var _exercism$xelm$Raindrops$isDivisibleBy5 = function (num) {
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], num, 5),
		0) ? 'Plang' : '';
};
var _exercism$xelm$Raindrops$isDivisibleBy3 = function (num) {
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], num, 3),
		0) ? 'Pling' : '';
};
var _exercism$xelm$Raindrops$raindrops = function (num) {
	var seven = _exercism$xelm$Raindrops$isDivisibleBy7(num);
	var five = _exercism$xelm$Raindrops$isDivisibleBy5(num);
	var three = _exercism$xelm$Raindrops$isDivisibleBy3(num);
	var str = _elm_lang$core$String$concat(
		_elm_lang$core$Native_List.fromArray(
			[three, five, seven]));
	var strNum = _elm_lang$core$Basics$toString(num);
	return _elm_lang$core$String$isEmpty(str) ? strNum : str;
};
