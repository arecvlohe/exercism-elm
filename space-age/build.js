...
var _exercism$xelm$SpaceAge$toDays = function (time) {
	return ((time / 60) / 60) / 24;
};
var _exercism$xelm$SpaceAge$ageOn = F2(
	function (planet, time) {
		var _p0 = planet;
		switch (_p0.ctor) {
			case 'Mercury':
				return _exercism$xelm$SpaceAge$toDays(time) / (0.2408467 * 365.25);
			case 'Venus':
				return _exercism$xelm$SpaceAge$toDays(time) / (0.61519726 * 365.25);
			case 'Earth':
				return _exercism$xelm$SpaceAge$toDays(time) / 365.25;
			case 'Mars':
				return _exercism$xelm$SpaceAge$toDays(time) / (1.8808158 * 365.25);
			case 'Jupiter':
				return _exercism$xelm$SpaceAge$toDays(time) / (11.862615 * 365.25);
			case 'Saturn':
				return _exercism$xelm$SpaceAge$toDays(time) / (29.447498 * 365.25);
			case 'Uranus':
				return _exercism$xelm$SpaceAge$toDays(time) / (84.016846 * 365.25);
			default:
				return _exercism$xelm$SpaceAge$toDays(time) / (164.79132 * 365.25);
		}
	});
		...
		[
			...
			A2(
				...
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Earth, 1000000000)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				...
				281,
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Mercury, 2134835688)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'age in venus years',
			A2(
				...
				10,
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Venus, 189839836)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'age on mars',
			A2(
				...
				39,
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Mars, 2329871239)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'age on jupiter',
			A2(
				...
				2,
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Jupiter, 901876382)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'age on saturn',
			A2(
				...
				3,
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Saturn, 3000000000)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'age on uranus',
			A2(
				...
				1,
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Uranus, 3210123456)))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'age on neptune',
			A2(
				...
				2,
				_elm_lang$core$Basics$round(
					A2(_exercism$xelm$SpaceAge$ageOn, _exercism$xelm$SpaceAge$Neptune, 8210123456))))
		]));
