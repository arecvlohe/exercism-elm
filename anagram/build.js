...
var _exercism$xelm$Anagram$charCodes = function (str) {
	return _elm_lang$core$List$sort(
		A2(
			_elm_lang$core$List$map,
			function (x) {
				return _elm_lang$core$Char$toCode(x);
			},
...
var _exercism$xelm$Anagram$detect = F2(
	function (str, list) {
		...
		var newList = A2(
			...
			function (x) {
				return _elm_lang$core$Native_Utils.eq(
					...
					_elm_lang$core$String$length(str)) && (!_elm_lang$core$Native_Utils.eq(
		...
		var valid = A2(
			...
			function (x) {
				return _elm_lang$core$Native_Utils.eq(
					_exercism$xelm$Anagram$charCodes(
						_elm_lang$core$String$toLower(x)),
					_exercism$xelm$Anagram$charCodes(
						_elm_lang$core$String$toLower(str)));
			},
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					function (x) {
						return A2(_elm_lang$core$String$join, '', x);
					},
					matches)));
		return valid;
	});
