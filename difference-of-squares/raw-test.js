		...
		switch (_p6.ctor) {
			case 'Test':
				...
				return {
					...
					_1: A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_community$elm_test$Test_Runner$Runnable(
			...
			default:
				...
				return {
					...
					_1: _elm_lang$core$Native_List.fromArray(
						[
							_elm_community$elm_test$Test_Runner$Batch(
			...
			return _elm_community$elm_test$Test_Runner$Runnable(
				_elm_community$elm_test$Test_Runner$Thunk(
					function (_p14) {
						...
						return _elm_lang$core$Native_List.fromArray(
							[
								_elm_community$elm_test$Expect$fail(
								A2(
									_elm_lang$core$Basics_ops['++'],
...
var _exercism$xelm$DifferenceOfSquares$range = function (num) {
	return _elm_lang$core$Native_Utils.eq(num, 0) ? _elm_lang$core$Native_List.fromArray(
		[]) : A2(
		_elm_lang$core$List_ops['::'],
		num,
		_exercism$xelm$DifferenceOfSquares$range(num - 1));
};
var _exercism$xelm$DifferenceOfSquares$squareOfSum = function (num) {
	return function (x) {
		...
		_elm_lang$core$List$sum(
			_exercism$xelm$DifferenceOfSquares$range(num)));
};
...
var _rtfeldman$node_test_runner$Test_Runner_Node_App$defaultRunCount = 100;
...
var _rtfeldman$node_test_runner$Test_Runner_Node_App$timeToSeed = function (time) {
			...
			if (_p5.ctor === 'Init') {
				...
				var finalSeed = function () {
					...
					if (_p6.ctor === 'Just') {
						...
						return _rtfeldman$node_test_runner$Test_Runner_Node_App$timeToSeed(_p8);
					}
				}();
				var _p7 = A2(
					_p4._4,
					_p8,
					_rtfeldman$node_test_runner$Test_Runner_Node_App$toThunks(
						A3(_elm_community$elm_test$Test_Runner$fromTest, _p4._2, finalSeed, _p4._3)));
				var subModel = _p7._0;
				var subCmd = _p7._1;
				return {
					ctor: '_Tuple2',
...
var _rtfeldman$node_test_runner$Test_Runner_Node_App$Uninitialized = F5(
	function (a, b, c, d, e) {
...
var _rtfeldman$node_test_runner$Test_Runner_Node_App$run = F3(
	function (runnerOpts, appOpts, test) {
		...
		var runs = A2(_elm_lang$core$Maybe$withDefault, _rtfeldman$node_test_runner$Test_Runner_Node_App$defaultRunCount, runnerOpts.runs);
		var init = {
			ctor: '_Tuple2',
			_0: A5(_rtfeldman$node_test_runner$Test_Runner_Node_App$Uninitialized, appOpts.update, runnerOpts.seed, runs, test, appOpts.init),
			_1: cmd
		};
...
var _rtfeldman$node_test_runner$Test_Runner_Node$failureToChalk = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2.given;
	var messageChalk = {
		styles: _elm_lang$core$Native_List.fromArray(
		...
		text: A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_rtfeldman$node_test_runner$Test_Runner_Node$indent(_p2.message),
				'\n\n'))
	};
	return _elm_lang$core$String$isEmpty(_p3) ? _elm_lang$core$Native_List.fromArray(
...
var _rtfeldman$node_test_runner$Test_Runner_Node$chalkAllFailures = F2(
	function (emit, _p4) {
		var _p5 = _p4;
		var _p6 = A2(_elm_lang$core$List$filterMap, _elm_community$elm_test$Expect$getFailure, _p5.expectations);
		if (_p6.ctor === '[]') {
			...
			var encoded = _elm_lang$core$Json_Encode$list(
				A2(
					...
					A2(_rtfeldman$node_test_runner$Test_Runner_Node$failuresToChalk, _p5.labels, _p6)));
			return emit(
	...
	function (emit, msg, model) {
		...
		switch (_p7.ctor) {
			case 'Finish':
				...
				var duration = _p7._0 - model.startTime;
			...
			case 'Complete':
				var result = {labels: _p7._1._0, expectations: _p7._1._1, duration: _p7._3 - _p7._2};
			...
			default:
				...
				if (_p9.ctor === '[]') {
					...
					var _p11 = _p9._0;
					var _p10 = A2(_elm_lang$core$Dict$get, _p11, model.available);
					if (_p10.ctor === 'Nothing') {
						...
						var available = A2(_elm_lang$core$Dict$remove, _p11, model.available);
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{available: available, queue: _p9._1});
						var complete = A3(
...
var _rtfeldman$node_test_runner$Test_Runner_Node$init = F2(
	function (startTime, thunks) {
		...
		return {ctor: '_Tuple2', _0: model, _1: _rtfeldman$node_test_runner$Test_Runner_Node$dispatch};
	});
var _rtfeldman$node_test_runner$Test_Runner_Node$runWithOptions = F3(
	function (runs, seed, emit) {
		return A2(
			_rtfeldman$node_test_runner$Test_Runner_Node_App$run,
			{runs: runs, seed: seed},
			{
				init: _rtfeldman$node_test_runner$Test_Runner_Node$init,
...
var _rtfeldman$node_test_runner$Test_Runner_Node$run = A2(_rtfeldman$node_test_runner$Test_Runner_Node$runWithOptions, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _exercism$xelm$Main$main === 'undefined' ? null : _exercism$xelm$Main$main);
